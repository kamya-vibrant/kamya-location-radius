    ...
    var settingsObject = {
        ...
        settings: {
            layout: {
                ...
                boxed: false,
                logo: {
                    darkLogo: '../src/assets/img/msl-logo.png',
                    lightLogo: '../src/assets/img/msl-logo.png'
                }
            }
        },
        reset: false
        ...
        if (getParseObject.settings.layout.darkMode) {
            ...
            if (ifStarterKit) {
                if (document.querySelector('.navbar-logo')) {
                    document.querySelector('.navbar-logo').setAttribute('src', '../../src/assets/img/msl-logo.png')
                }
            } else {
                if (document.querySelector('.navbar-logo')) {
