...
const routes = {
    ...
    '/checkout-editmeal': `/pages/checkout-editmeal.html`,
...
const bannerPop = async (route) => {
  console.log('route:',route);
    ...
    // }else{
    //     if(document.getElementById('banner-main')==true)document.getElementById('banner-main').style = 'display: none;';
    // }
}
